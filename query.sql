...
CREATE TABLE `complete` (
  ...
  `n_strawberry` int(11) DEFAULT NULL,
  `n_banana` int(11) DEFAULT NULL,
...
INSERT INTO `result` VALUES (1,0,0);
...
-- Dump completed on 2017-05-22 14:47:11
